...
async function fetchCountries() {
    try {
        ...
        console.log(data);
        for(let i = 0; i < response.data.length; i++)countriesOnScreen.innerHTML += `<div class="${regionColor(data[i].region)}"><li></li> <img class="flags" src="${data[i].flags.png}" alt="${data[i].flags.alt}"> <span class="${regionColor(data[i].region)}">${data[i].name}</span>
...
/*response.data[0].name.common*/ fetchCountries();
...
var Buffer = require("8246e2926ffd9dd").Buffer;
"use strict";
/**
...
},{"8246e2926ffd9dd":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("cf0db76d4ac04908");
var ieee754 = require("17487200363a4824");
...
},{"cf0db76d4ac04908":"eIiSV","17487200363a4824":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
