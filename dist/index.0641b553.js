...
async function fetchCountries() {
    try {
        ...
        console.log(data);
        for(let i = 0; i < response.data.length; i++)countriesOnScreen.innerHTML += `<div class="${regionColor(data[i].region)}"> <img class="flags" src="${data[i].flags.png}" alt="${data[i].flags.alt}"> ${data[i].name}
